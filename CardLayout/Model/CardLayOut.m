...
- (CGSize)collectionViewContentSize {
    ...
    CGFloat width = self.scrollDirection==UICollectionViewScrollDirectionHorizontal ? count*(self.itemSize.width+self.spacing)+self.edgeInset.left+self.edgeInset.right+(self.collectionView.bounds.size.width-self.itemSize.width)/2 : self.collectionView.bounds.size.width;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    attribute.frame = CGRectMake(x+(self.collectionView.bounds.size.width-self.itemSize.width)/2-self.edgeInset.left , y, attribute.size.width, attribute.size.height);
